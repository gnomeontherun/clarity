...
export class CdsAlertDirective extends BaseCdsDirective<CdsAlert> {
  get size() {
  ...
  get closeIconTitle() {
    return this.element.closeIconTitle;
  }
  @Input() set closeIconTitle(value) {
    this.element.closeIconTitle = value;
  }
}
