...
@Component({
  ...
  template: `
    ...
    <div class="clr-control-container" [ngClass]="controlClass()" #controlContainer>
      ...
      <cds-icon *ngIf="showInvalid" class="clr-validate-icon" shape="exclamation-circle" aria-hidden="true"></cds-icon>
      <cds-icon *ngIf="showValid" class="clr-validate-icon" shape="check-circle" aria-hidden="true"></cds-icon>
