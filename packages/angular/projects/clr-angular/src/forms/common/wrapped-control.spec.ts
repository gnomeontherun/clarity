...
@Component({
  template: ` <form-wrapper>
    <test-wrapper3
      ><input testControl3 [(ngModel)]="model" required /><clr-control-helper>Helper</clr-control-helper></test-wrapper3
    >
  </form-wrapper>`,
})
...
@Component({
  template: ` <form-wrapper>
    <test-wrapper3
      ><input testControl3 [(ngModel)]="model" required /><clr-control-error>Error</clr-control-error></test-wrapper3
    >
  </form-wrapper>`,
})
...
@Component({
  template: ` <form-wrapper>
    <test-wrapper3
      ><input testControl3 [(ngModel)]="model" required /><clr-control-success
        >Success</clr-control-success
      ></test-wrapper3
    >
  </form-wrapper>`,
})
